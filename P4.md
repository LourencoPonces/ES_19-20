...
#### F4: _O aluno pode pedir esclarecimentos adicionais_
 ...
 - [x] Cypress use case tests: [teacher](https://github.com/tecnico-softeng/es20al_19-project/blob/P4/frontend/tests/e2e/specs/teacher/manageClarificationRequests.js) and [student](https://github.com/tecnico-softeng/es20al_19-project/blob/P4/frontend/tests/e2e/specs/student/manageClarificationRequests.js)
   + Screenshot:
...
The list of pull requests associated with this feature is:
 ...
 - [F6 & F11: PR #360](https://github.com/tecnico-softeng/es20al_19-project/pull/360)
 - [F7 & F8: PR #357](https://github.com/tecnico-softeng/es20al_19-project/pull/357)
    - **Note:** The socre calculation is not done.
...
#### F5: _Se o número de alunos inscritos, incluindo o criador do torneio, for superior a 1, o sistema gera o quiz associado ao torneio_
 ...
 - [x] [Service](https://github.com/tecnico-softeng/es20al_19-project/blob/develop/backend/src/main/java/pt/ulisboa/tecnico/socialsoftware/tutor/tournament/TournamentService.java#L142)
 - [x] [Spock tests](https://github.com/tecnico-softeng/es20al_19-project/blob/develop/backend/src/test/groovy/pt/ulisboa/tecnico/socialsoftware/tutor/tournament/service/SignUpInTournamentTest.groovy#L142)

#### F6: _Os alunos participantes respodem às perguntas no período definido para o torneio_

 - [x] [Service](https://github.com/tecnico-softeng/es20al_19-project/blob/develop/backend/src/main/java/pt/ulisboa/tecnico/socialsoftware/tutor/tournament/TournamentService.java#L214)
 - [x] [Spock tests](https://github.com/tecnico-softeng/es20al_19-project/blob/develop/backend/src/test/groovy/pt/ulisboa/tecnico/socialsoftware/tutor/tournament/service/GetTournamentQuizTest.groovy)
 - [x] [JMeter feature tests](https://github.com/tecnico-softeng/es20al_19-project/blob/develop/backend/jmeter/tournament/WSGetTournamentQuizTest.jmx)
   + Screenshots:

     ![Test results](p4-images/TdP_f6_jmeter.png)

 - [x] [Cypress use case test](https://github.com/tecnico-softeng/es20al_19-project/blob/develop/frontend/tests/e2e/specs/student/tournament/getTournamentQuiz.js)
   + Screenshot:
...
#### F11: _Os alunos podem aceder aos torneios em que estão inscritos e estão em execução_
 ...
 - [x] [Service](https://github.com/tecnico-softeng/es20al_19-project/blob/develop/backend/src/main/java/pt/ulisboa/tecnico/socialsoftware/tutor/tournament/TournamentService.java#L195)
 - [x] [Spock tests](https://github.com/tecnico-softeng/es20al_19-project/blob/develop/backend/src/test/groovy/pt/ulisboa/tecnico/socialsoftware/tutor/tournament/service/GetSignedUpRunningTournamentsTest.groovy)
 - [x] [JMeter feature tests](https://github.com/tecnico-softeng/es20al_19-project/blob/develop/backend/jmeter/tournament/WSGetSignedUpRunningTournamentTest.jmx)
   + Screenshots:

     ![Test results](p4-images/TdP_f11_jmeter.png)

 - [x] [Cypress use case test](https://github.com/tecnico-softeng/es20al_19-project/blob/develop/frontend/tests/e2e/specs/student/tournament/getSignedUpRunningTournaments.js)
   + Screenshot:
