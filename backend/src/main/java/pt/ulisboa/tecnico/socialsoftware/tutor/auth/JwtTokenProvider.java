...
public class JwtTokenProvider {
    ...
    private static final SecretKey AUTOGENERATED_SECRET = generateSecret();
    ...
    public JwtTokenProvider(UserRepository userRepository, @Value("${jwt.secret:null}") String key) {
        this.userRepository = userRepository;

        if (secretKey == null || secretKey.equals("null")) {
            // using a static secret to avoid consistency issues with multiple JwtTokenProvider instances
            secretKey = AUTOGENERATED_SECRET;
            logger.warn("Using autogenerated secret for JWT signatures");
        } else {
